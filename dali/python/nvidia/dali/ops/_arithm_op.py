...
from nvidia.dali.types import (_bool_types, _int_like_types, _float_types, ScalarConstant as
                               _ScalarConstant, DALIDataType)
from nvidia.dali import _conditionals
from nvidia.dali.ops._operator_utils import _choose_device
...
def _arithm_op(name, *inputs):
    ...
    from nvidia.dali.ops import ArithmeticGenericOp
