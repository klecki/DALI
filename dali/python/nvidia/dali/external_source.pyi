...
from typing import Any, Sequence, List, Callable, Iterable, Literal

from nvidia.dali.data_node import DataNode
from nvidia.dali.types import DALIDataType, DALIImageType, DALIInterpType

from nvidia.dali._typing import TensorLike, BatchLike
...
class ExternalSource:
    ...
    def __init__(
        self,
        source: Optional[Union[Callable[..., Any], Iterable[Any], Callable[..., Sequence[Any]],
...
@overload
def external_source(
    source: Optional[Union[Callable[..., TensorLike], Iterable[TensorLike]]] = None,
    *,
    batch: Literal[False],
    batch_info: Optional[bool] = False,
...
@overload
def external_source(
    source: Optional[Union[Callable[..., BatchLike], Iterable[BatchLike]]] = None,
    *,
    batch: Literal[True],
    batch_info: Optional[bool] = False,
    dtype: Union[DALIDataType, Sequence[DALIDataType], None] = None,
...
# Default case, where we do not disambiguate between batch modes
@overload
def external_source(
    source: Optional[Union[Callable[..., Union[TensorLike, BatchLike]],
                           Iterable[Union[TensorLike, BatchLike]]]] = None,
    *,
    batch: Optional[bool] = None,
    batch_info: Optional[bool] = False,
    dtype: Union[DALIDataType, Sequence[DALIDataType], None] = None,
