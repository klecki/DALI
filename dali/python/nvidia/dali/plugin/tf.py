...
if dataset_compatible_tensorflow():
    ...
    def pass_on_cpu(target_device, source_device="/cpu:0"):
    ...
    """
        def _apply_fn(dataset):
            ...
            return _PassOnCpuDataset(dataset, target_device=target_device,
                                    source_device=source_device).with_options(options)

        return _apply_fn


    class _PassOnCpuDataset(dataset_ops.UnaryUnchangedStructureDataset):
        ...
        """
            ...
            wrap_ds_variant = gen_dataset_ops.wrap_dataset_variant(self._input_dataset._variant_tensor)  # pylint: disable=protected-access
            ...
            def _init_func():
                ...
                resource = gen_dataset_ops.anonymous_iterator(**self._input_dataset._flat_structure)  # pylint: disable=protected-access
            ...
            def _remote_init_func():
                return _dali_tf_module.pass_cpu_remote_call(target=self._source_device,
            ...
            @function.defun_with_attributes(input_signature=[tensor_spec.TensorSpec([], dtypes.string)])
            def _remote_next_func(string_handle):
                return _dali_tf_module.pass_cpu_remote_call(
            ...
            def _finalize_func(string_handle):
                ...
                iterator_resource = gen_dataset_ops.iterator_from_string_handle_v2(
                    string_handle, **self._input_dataset._flat_structure)  # pylint: disable=protected-access
                with ops.control_dependencies([
                        resource_variable_ops.destroy_resource_op(iterator_resource,
            ...
            super(_PassOnCpuDataset, self).__init__(input_dataset, variant_tensor)
        ...
        def make_one_shot_iterator(self):
            if self._is_gpu_target:
                ...
                return super(_PassOnCpuDataset, self).make_one_shot_iterator()
