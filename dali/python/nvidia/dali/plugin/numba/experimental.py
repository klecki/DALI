...
class NumbaFunction(metaclass=ops._DaliOperatorMeta):
    ...
    def _setup_fn_sig(self):
        return numba_types.void(
            numba_types.uint64, numba_types.uint64, numba_types.int32, numba_types.uint64,
            numba_types.uint64, numba_types.int32, numba_types.int32
        )
    ...
    def _get_setup_fn_cpu(self, setup_fn):
        ...
        if setup_fn is not None:
            ...
            def setup_cfunc(
                out_shapes_ptr, out_ndims_ptr, num_outs, in_shapes_ptr, in_ndims_ptr, num_ins,
                num_samples
            ):
    ...
    def _get_run_fn_cpu(self, run_fn, out_types, in_types, outs_ndim, ins_ndim, batch_processing):
        ...
        if batch_processing:
            ...
            def run_cfunc(
                out_ptr, out_shapes_ptr, out_ndims_ptr, num_outs, in_ptr, in_shapes_ptr,
