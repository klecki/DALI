...
// struct SeparableConvolutionGpu<Out, In, W, 1, has_channels> {
...
//   ConvolutionGpu<Out, In, W, ndim, 0, has_channels> conv_;
// };

template <typename Out, typename In, typename W, bool has_channels>
struct SeparableConvolutionGpu<Out, In, W, 2, has_channels> {
  ...
  ConvolutionGpu<Out, Intermediate, W, ndim, 0, has_channels> conv_outermost_;
};

// template <typename Out, typename In, typename W, bool has_channels>
// struct SeparableConvolutionGpu<Out, In, W, 3, has_channels> {
...
//   ConvolutionGpu<Intermediate, In, W, ndim, 2, has_channels> conv_innermost_;
//   ConvolutionGpu<Intermediate, Intermediate, W, ndim, 1, has_channels> conv_middle_;
//   ConvolutionGpu<Out, Intermediate, W, ndim, 0, has_channels> conv_outermost_;
// };
