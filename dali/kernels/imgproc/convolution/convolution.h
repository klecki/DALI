...
#ifndef DALI_KERNELS_IMGPROC_CONVOLUTION_CONVOLUTION_H_
#define DALI_KERNELS_IMGPROC_CONVOLUTION_CONVOLUTION_H_
...
#endif  // DALI_KERNELS_IMGPROC_CONVOLUTION_CONVOLUTION_H_