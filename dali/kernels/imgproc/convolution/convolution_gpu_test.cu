...
struct ConvolutionGpuKernelTest : public ::testing::Test {
  ...
  void RunTest() {
    ...
    // printf("CUTLASS\n\n");
    // print_mat(out_cpu_[0].shape[0], out_cpu_[0].shape[1], out_cpu_[0].data);
    // printf("CPU baseline\n\n");
    // print_mat(baseline_out_[0].shape[0], baseline_out_[0].shape[1], baseline_out_[0].data);
  }
  ...
  // const TensorListShape<> shape_ch_ = {{29, 145, 128, 3}};
  // const TensorListShape<> shape_noch_ = {{29, 145, 128}};

  const TensorListShape<> shape_ch_ = {{29, 145, 128, 3}, {64, 64, 64, 3}, {164, 164, 164, 3}, {12, 12, 12, 3}, {4, 200, 180, 3}, {200, 4, 180, 3}, {75, 75, 75, 5}};
  const TensorListShape<> shape_noch_ = {{29, 145, 128}, {64, 64, 64}, {164, 164, 164}, {12, 12, 12}, {4, 200, 180}, {200, 4, 180}, {75, 75, 75}};
...
//   convolution_params<2, false, 0, 37, float>,
//   convolution_params<2, false, 1, 37, float>
//   >;
using ConvolutionTestValues = ::testing::Types<
