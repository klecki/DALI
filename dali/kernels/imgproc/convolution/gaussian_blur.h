...
//   std::tuple<SeparableConvolution<
// };
...
//   SeparableConvolution<Out, In, W, effective_ndim, has_channels> conv_;
// };
...
struct GaussianBlur<Out, In, W, 2, has_channels> {
  ...
  SeparableConvolution<W, In, W, ndim, has_channels> conv_innermost_;
  SeparableConvolution<Out, W, W, ndim, has_channels> conv_outermost_;
...
struct GaussianBlur<Out, In, W, 3, has_channels> {
  ...
  SeparableConvolution<W, In, W, effective_ndim, has_channels> conv_innermost_;
  SeparableConvolution<W, In, W, effective_ndim, has_channels> conv_middle_;
  SeparableConvolution<Out, W, W, effective_ndim, has_channels> conv_outermost_;
};
