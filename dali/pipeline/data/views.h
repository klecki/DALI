...
template <typename T, int ndim = DynamicDimensions, typename Backend>
TensorView<detail::storage_tag_map_t<Backend>, T, ndim> view(Tensor<Backend> &data) {
...
template <typename T, int ndim = DynamicDimensions, typename Backend>
TensorView<detail::storage_tag_map_t<Backend>, T, ndim> view_as_tensor(Tensor<Backend> &data) {
  return view<T, ndim>(data);
}

template <typename T, int ndim = DynamicDimensions, typename Backend>
TensorView<detail::storage_tag_map_t<Backend>, T, ndim> view_as_tensor(TensorList<Backend> &data) {
  if (data.ntensor() == 0) return {};
  using U = std::remove_const_t<T>;
...
template <typename T, int ndim = DynamicDimensions, typename Backend>
TensorView<detail::storage_tag_map_t<Backend>, T, ndim> view(const Tensor<Backend> &data) {
  static_assert(std::is_const<T>::value,
...
template <typename T, int ndim = DynamicDimensions, typename Backend>
TensorView<detail::storage_tag_map_t<Backend>, T, ndim> view_as_tensor(
    const Tensor<Backend> &data) {
  return view<T, ndim>(data);
}
...
template <typename T, int ndim = DynamicDimensions, typename Backend>
TensorListView<detail::storage_tag_map_t<Backend>, T, ndim> view(TensorVector<Backend> &data) {
...
template <typename T, int ndim = DynamicDimensions, typename Backend>
TensorListView<detail::storage_tag_map_t<Backend>, T, ndim> view(
    const TensorVector<Backend> &data) {
  static_assert(std::is_const<T>::value,
