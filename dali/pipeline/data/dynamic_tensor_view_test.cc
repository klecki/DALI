...
TEST(DynamicTensorViewTest, DefaultConstructors) {
  ...
  ConstDynamicTensorView<EmptyBackendTag, 4> const_empty_static_dim{};
  compare(const_empty_static_dim, nullptr, TensorShape<4>{}, DALI_NO_TYPE);

  ConstDynamicTensorView<EmptyBackendTag> const_empty_dynamic_dim{};
...
TEST(ConstDynamicTensorViewTest, PtrConstructors) {
  int data = {};
  ConstDynamicTensorView<EmptyBackendTag, 4> const_empty_static_dim{&data, {1, 2, 3, 4}};
  compare(const_empty_static_dim, &data, TensorShape<4>{1, 2, 3, 4}, DALI_INT32);

  ConstDynamicTensorView<EmptyBackendTag, 4> const_empty_static_dim_conv{&data, TensorShape<>{1, 2, 3, 4}};
  compare(const_empty_static_dim_conv, &data, TensorShape<4>{1, 2, 3, 4}, DALI_INT32);

  ConstDynamicTensorView<EmptyBackendTag> const_empty_dynamic_dim{&data, {1, 2, 3, 4}};
  compare(const_empty_dynamic_dim, &data, TensorShape<>{1, 2, 3, 4}, DALI_INT32);

  ConstDynamicTensorView<EmptyBackendTag> const_empty_dynamic_dim_conv{&data, TensorShape<4>{1, 2, 3, 4}};
  compare(const_empty_dynamic_dim_conv, &data ,  TensorShape<>{1, 2, 3, 4} , DALI_INT32);
}

TEST(ConstDynamicTensorViewTest, ConstPtrConstructors) {
  const int data = {};
  ConstDynamicTensorView<EmptyBackendTag, 4> const_empty_static_dim{&data, {1, 2, 3, 4}};
  compare(const_empty_static_dim, &data ,  TensorShape<4>{1, 2, 3, 4} , DALI_INT32);
...
TEST(DynamicTensorViewTest, NullPtrConstructors) {
  ...
  ConstDynamicTensorView<EmptyBackendTag, 4> const_empty_static_dim{nullptr, {1, 2, 3, 4}};
  compare(const_empty_static_dim, nullptr ,  TensorShape<4>{1, 2, 3, 4} , DALI_NO_TYPE);

  ConstDynamicTensorView<EmptyBackendTag> const_empty_dynamic_dim{nullptr, {1, 2, 3, 4}};
...
TEST(DynamicTensorViewTest, ViewConverterConstructors) {
  ...
  DynamicTensorView<EmptyBackendTag> copy_static_to_dynamic{static_dim};
  compare(copy_static_to_dynamic, tv);


  DynamicTensorView<EmptyBackendTag, 3> copy_dynamic_to_static{dynamic_dim};
  compare(copy_dynamic_to_static, tv);

  DynamicTensorView<EmptyBackendTag, 3> copy_dynamic_to_dynamic{dynamic_dim};
...
TEST(ConstDynamicTensorViewTest, ViewConverterConstructors) {
  ...
  ConstDynamicTensorView<EmptyBackendTag> copy_static_to_dynamic{static_dim};
  compare(copy_static_to_dynamic, ctv);

  ConstDynamicTensorView<EmptyBackendTag, 3> copy_dynamic_to_static{dynamic_dim};
  compare(copy_dynamic_to_static, ctv);

  ConstDynamicTensorView<EmptyBackendTag, 3> copy_dynamic_to_dynamic{dynamic_dim};
