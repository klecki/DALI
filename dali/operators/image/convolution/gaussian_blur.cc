...
is used for ``H`` and ``sigma_1`` for ``W``.
    ...
    .AddOptionalArg<int>("window_size_0", "The diameter of kernel window", nullptr, true)
    .AddOptionalArg<int>("window_size_1", "The diameter of kernel window", nullptr, true)
    .AddOptionalArg<int>("window_size_2", "The diameter of kernel window", nullptr, true)
