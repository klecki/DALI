...
#ifndef DALI_OPERATORS_DECODER_NVJPEG_DECOUPLED_API_NVJPEG_HELPER_H_
#define DALI_OPERATORS_DECODER_NVJPEG_DECOUPLED_API_NVJPEG_HELPER_H_
...
inline uint8_t GetJpegEncoding(const uint8_t* input, size_t size) {
  if (input[0] != 0xff || input[1] != 0xd8) return 0;
...
#endif  // DALI_OPERATORS_DECODER_NVJPEG_DECOUPLED_API_NVJPEG_HELPER_H_
