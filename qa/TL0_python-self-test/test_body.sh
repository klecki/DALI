...
test_nose() {
    for test_script in $(ls test_operator_*.py test_pipeline*.py test_external_source_dali.py test_external_source_numpy.py test_external_source_parallel.py test_functional_api.py test_backend_impl.py); do
